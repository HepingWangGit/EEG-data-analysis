...
print('Total amount of files in test directory: ' + str(len(os.listdir('Desktop/eeg/Test/'))))


# In[4]:


filenames_list = os.listdir('Desktop/eeg/Test/')
#print('File list contains in test directory: ' + str(filenames_list))
...
for file_name in tqdm(filenames_list):
    temp_df = pd.read_csv('Desktop/eeg/Test/' + file_name)
...
sensorvalueMean=EEG_data["sensor value"].describe()
print(sensorvalueMean)


# In[17]:


EEG_data.groupby('subject identifier')['name'].nunique()


# In[18]:


# Data cleaning for the position of the sensor
...
print("View reject the null: ",sum(stat_test_results.reject_null == True))
